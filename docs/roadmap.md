...
- **Revamp de UI, fase 1** (2026-08). Se propusieron tres direcciones y se eligió **"archivo con evidencia técnica"**: serif y papel para la respuesta (es prosa, se lee), mono y densidad para la evidencia (son datos, se escanean). Esa tensión *es* el producto — lenguaje natural apoyado en algo verificable — y es lo que diferencia a Lorebase de un clon de ChatGPT, que es lo que la UI venía imitando.
...
| 29 | Revamp fase 1: tokens semánticos, paleta, tipografía y dark mode | Pedido | Etapa 13 |
